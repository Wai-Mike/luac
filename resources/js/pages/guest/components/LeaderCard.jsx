export default function LeaderCard({ name, role, image, featured = false }) {
    return (
        <article className={`overflow-hidden rounded-2xl bg-white text-center shadow-sm ${featured ? 'border-2 border-brand-dark' : 'border border-brand/10'}`}>
            ...
            <div className="p-4">
                <p className="text-[11px] font-semibold uppercase tracking-widest text-amber-dark">{role}</p>
