            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
                    ...
                    <div className="rounded-2xl border border-gray-200 bg-white p-8">
                        ...
                        {isSubmitted ? (
                            <div className="rounded-2xl border border-gray-200 bg-brand-surface p-8 text-center">
                                ...
                                <h4 className="mb-2 text-2xl font-bold text-gray-900">Message sent successfully</h4>
                                <p className="mb-4 text-gray-600">Thank you for contacting us. We'll get back to you soon.</p>
                                <button
                                    onClick={() => setIsSubmitted(false)}
                                    className="rounded-md bg-brand px-6 py-3 font-medium text-white transition-colors hover:bg-brand-light"
                                >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full rounded-xl border px-4 py-3 transition-all focus:ring-2 focus:ring-brand/20 ${
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleInputChange}
                                        rows={5}
                                        className={`w-full resize-none rounded-xl border px-4 py-3 transition-all focus:ring-2 focus:ring-brand/20 ${
                                            errors.message ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-brand'
                                        }`}
                                ...
                                <button
                                    type="submit"
                                    disabled={isSubmitting}
                                    className="w-full rounded-xl bg-brand px-6 py-4 text-lg font-semibold text-white transition-colors hover:bg-brand-light disabled:cursor-not-allowed disabled:opacity-50"
                                >
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="rounded-xl border border-gray-200 bg-gray-50/50 p-6">
                            ...
                            <div className="flex space-x-4">
                                <a
                                    href="#"
                                    className="flex h-12 w-12 items-center justify-center rounded-xl bg-brand text-white transition-colors hover:bg-brand-light"
                                >
                                ...
                                <a
                                    href="#"
                                    className="flex h-12 w-12 items-center justify-center rounded-xl bg-brand-light text-white transition-colors hover:opacity-90"
                                >
                                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a
                                    href="#"
                                    className="flex h-12 w-12 items-center justify-center rounded-xl bg-brand-soft text-white transition-colors hover:opacity-90"
                                >
                                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
