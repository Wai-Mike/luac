...
export default function index({ heroImage, heroImages = [], galleryItems = [], videos = [], raisedByProgram = {}, raisedSspByProgram = {} }) {
    return (
        <GuestLayout title="LAYYA">
            <LayyaHeroSection heroImage={heroImage} heroImages={heroImages} />
