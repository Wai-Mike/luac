        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="relative flex min-h-[80vh] items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0">
                    <img src="/images/cover1.jpg" alt="LAYYA youth programs and activities" className="h-full w-full object-cover" />
                    <div className="absolute inset-0 bg-gradient-to-br from-teal-600/60 via-emerald-600/60 to-amber-500/60"></div>
                </div>
                            ...
                            >
                                <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                                    <div className="mb-4 flex items-center">
                                        <div className="mr-4 h-16 w-16 flex-shrink-0 overflow-hidden rounded-xl ring-2 ring-teal-200 shadow-md">
                                            <img
                                                src={program.icon}
                                                alt={program.title}
                                ...
                                <div className={index % 2 === 1 ? 'lg:col-start-1' : ''}>
                                    <div
                                        className="relative flex h-80 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-teal-50 to-emerald-50 p-8 group"
                                    >
                                        <img
                                            src={program.icon}
                                            alt={program.title}
            ...
            <div className="bg-gray-50 py-20">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                        <div className="text-center">
                            <div className="mb-4 text-4xl font-bold text-teal-600">2023</div>
                        ...
                        <div className="text-center">
                            <div className="mb-4 text-4xl font-bold text-teal-600">2,000+</div>
                        ...
                        <div className="text-center">
                            <div className="mb-4 text-4xl font-bold text-teal-600">1,000+</div>
                        ...
                        <div className="text-center">
                            <div className="mb-4 text-4xl font-bold text-teal-600">€15,000</div>
            ...
            {/* CTA Section */}
            <div className="bg-gradient-to-r from-teal-700 via-emerald-600 to-amber-500 py-20 text-white">
                <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
                        <Link
                            href={route('contact')}
                            className="transform rounded-full border-2 border-white px-8 py-4 text-lg font-semibold text-white transition-all duration-200 hover:scale-105 hover:bg-white hover:text-teal-700"
                        >
                            Partner With Us
                        </Link>
                    </div>
