            ...
            <section className="bg-brand-soft py-20 md:py-28">
                <div className="mx-auto grid max-w-5xl gap-6 px-4 sm:grid-cols-3 sm:px-6">
                    <div className="rounded-3xl bg-white p-6">
                        <p className="text-xs font-semibold uppercase tracking-widest text-amber-dark">Total youth</p>
                    ...
                    <div className="rounded-3xl bg-white p-6">
                        <p className="text-xs font-semibold uppercase tracking-widest text-amber-dark">By gender</p>
                    ...
                    <div className="rounded-3xl bg-white p-6">
                        <p className="text-xs font-semibold uppercase tracking-widest text-amber-dark">Top counties</p>
                        <ul className="mt-3 space-y-2 text-sm text-brand-ink">
