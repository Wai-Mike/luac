...
Route::middleware(['auth', 'verified', 'admin.access'])
    ...
    ->group(function () {
        ...
        Route::post('/finances/budgets', [FinanceController::class, 'updateBudget'])->name('finances.budgets.update');
        ...
        Route::post('/operations/reports/{report}/approve', [OperationsController::class, 'approveReport'])->name('operations.reports.approve');
        Route::delete('/operations/reports/{report}', [OperationsController::class, 'destroyReport'])->name('operations.reports.destroy');
        Route::get('/operations/reports/{report}', [OperationsController::class, 'showReport'])->name('operations.reports.show');
        Route::get('/operations/reports/{report}/download', [OperationsController::class, 'downloadReport'])->name('operations.reports.download');
        ...
        Route::post('/operations/events', [OperationsController::class, 'storeEvent'])->name('operations.events.store');
        Route::put('/operations/events/{event}', [OperationsController::class, 'updateEvent'])->name('operations.events.update');
        Route::delete('/operations/events/{event}', [OperationsController::class, 'destroyEvent'])->name('operations.events.destroy');
        Route::get('/operations/events/{event}/documents/{document}', [OperationsController::class, 'showEventDocument'])->name('operations.events.documents.show');
        Route::get('/operations/events/{event}/documents/{document}/download', [OperationsController::class, 'downloadEventDocument'])->name('operations.events.documents.download');
        Route::post('/operations/purchase-requests', [OperationsController::class, 'storePurchaseRequest'])->name('operations.purchase-requests.store');
        Route::post('/operations/purchase-requests/{purchaseRequest}/review', [OperationsController::class, 'reviewPurchaseRequest'])->name('operations.purchase-requests.review');
        Route::post('/operations/purchase-requests/{purchaseRequest}/release-hold', [OperationsController::class, 'releasePurchaseRequestHold'])->name('operations.purchase-requests.release-hold');
        Route::post('/operations/purchase-requests/{purchaseRequest}/approve', [OperationsController::class, 'approvePurchaseRequest'])->name('operations.purchase-requests.approve');
        Route::post('/operations/purchase-requests/{purchaseRequest}/pay', [OperationsController::class, 'payPurchaseRequest'])->name('operations.purchase-requests.pay');
        Route::get('/operations/purchase-requests/{purchaseRequest}', [OperationsController::class, 'showPurchaseRequest'])->name('operations.purchase-requests.show');
        Route::get('/operations/purchase-requests/{purchaseRequest}/download', [OperationsController::class, 'downloadPurchaseRequest'])->name('operations.purchase-requests.download');
        Route::post('/operations/receipts', [OperationsController::class, 'storeReceipt'])->name('operations.receipts.store');
        Route::get('/operations/receipts/{receipt}', [OperationsController::class, 'showReceipt'])->name('operations.receipts.show');
        Route::get('/operations/receipts/{receipt}/download', [OperationsController::class, 'downloadReceipt'])->name('operations.receipts.download');
        Route::post('/operations/logistics', [OperationsController::class, 'storeLogistics'])->name('operations.logistics.store');
        Route::get('/operations/logistics/{logistics}', [OperationsController::class, 'showLogistics'])->name('operations.logistics.show');
        Route::get('/operations/logistics/{logistics}/download', [OperationsController::class, 'downloadLogistics'])->name('operations.logistics.download');
