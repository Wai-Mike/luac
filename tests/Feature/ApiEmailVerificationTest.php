...
class ApiEmailVerificationTest extends TestCase
{
    ...
    public function test_api_registration_returns_verification_status()
    {
        $userData = [
    ...
    public function test_unauthenticated_user_cannot_resend_verification()
    {
        $response = $this->postJson('/api/user/email/verify/resend');
